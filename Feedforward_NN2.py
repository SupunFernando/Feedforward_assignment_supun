...
model = Sequential()
model.add(Dense(16, input_dim=len(trainData[0]), activation="relu",kernel_regularizer=l2(0.001)))
...
model = Sequential()
model.add(Dense(16, input_dim=len(trainData[0]), activation="relu",kernel_regularizer=l2(0.01)))
...
print("AVERAGE OF F1 FOR ARCHHITECTURE 2 : ",totF1/5)
f1Case2=totF1/5
...
model = Sequential()
model.add(Dense(16, input_dim=len(trainData[0]), activation="relu",kernel_regularizer=l2(0.1)))
model.add(Dense(16, activation="relu",kernel_regularizer=l1(0.1)))
model.add(Dense(2, activation="softmax"))
opt = Adam(lr=1e-3, decay=1e-3 / 40)
model.compile(loss="categorical_crossentropy", optimizer=opt,metrics=['accuracy'])
...
print("AVERAGE OF F1 FOR ARCHITECTURE 3 : ",totF1/5)
f1Case3=totF1/5

print("Architecture 1 F1 (lamda =0.001) = ", f1Case1)
print("Architecture 2 F1 (lamda =0.01)= ", f1Case2)
print("Architecture 3 F1 (lamda =0.1)= ", f1Case3)